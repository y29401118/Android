            ...
            if (position == blockedRow) {
                ...
                builder.setPositiveButton(LocaleController.getString("ClearButton", R.string.ClearButton), (dialogInterface, i) -> {
                    ...
                    builder1.setPositiveButton(LocaleController.getString("ClearButton", R.string.ClearButton), (dialogInterface2, i2) -> {
                        ...
                        getConnectionsManager().sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(()->{
                            if(error == null){
                                Toast.makeText(getParentActivity(), LocaleController.getString("cleanSuccess", R.string.cleanSuccess), Toast.LENGTH_SHORT).show();
                            }else{
                                Toast.makeText(getParentActivity(), LocaleController.getString("cleanFail", R.string.cleanFail), Toast.LENGTH_SHORT).show();
                            }
