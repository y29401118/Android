...
public class ChatUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (listAdapter) {
                ...
                if(!ChatObject.isAllowAddFriend(currentChat)){
                    return;
                }
    ...
    private class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void searchUsers(final String query) {
            ...
            searchAdapterHelper.queryServerSearch(null, type != 0, false, true, true, false, ChatObject.isChannel(currentChat) ? chatId : 0, false, type, 0);
            notifyDataSetChanged();
        ...
        private void processSearch(final String query) {
            AndroidUtilities.runOnUIThread(() -> {
                ...
                searchAdapterHelper.queryServerSearch(query, selectType != 0, false, true, true, false, ChatObject.isChannel(currentChat) ? chatId : 0, false, type, 1);
            });
        }
