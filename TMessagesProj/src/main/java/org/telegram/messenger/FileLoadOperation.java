...
//    public FileLoadOperation(String apkUrl, Object parent) {
//        try {
//            parentObject = parent;
//
//            location = new TLRPC.TL_inputDocumentFileLocation();
//            location.id = 12233;
//            location.access_hash = 9999999999999L;
////            location.file_reference = documentLocation.file_reference;
//            location.thumb_size = "";
//            if (location.file_reference == null) {
//                location.file_reference = new byte[0];
//            }
//            initialDatacenterId = datacenterId = 996;
//            allowDisordererFileSave = true;
////            for (int a = 0, N = documentLocation.attributes.size(); a < N; a++) {
////                if (documentLocation.attributes.get(a) instanceof TLRPC.TL_documentAttributeVideo) {
////                    supportsPreloading = true;
...
////            }
//            if (ext.length() <= 1) {
//                ext = FileLoader.getExtensionByMimeType("wegram123");
//            }
//        } catch (Exception e) {
//            FileLog.e(e);
//            onFail(true, 0);
