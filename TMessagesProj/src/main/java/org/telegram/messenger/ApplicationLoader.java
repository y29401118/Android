...
public class ApplicationLoader extends Application {
    ...
    public void onCreate() {
        ...
        // 主进程
        if (Apps.isMainProcess(this)) {
            NativeLoader.initNativeLibs(ApplicationLoader.applicationContext);
            NativeLoader.setSocketHost(SharepeferenceUtil.getIp());
    ...
    private void initUM() {
        UMConfigure.preInit(getApplicationContext(), "610cda453451547e683e49bc", "wegram");
        UMConfigure.init(getApplicationContext(), "610cda453451547e683e49bc", "wegram", UMConfigure.DEVICE_TYPE_BOX, null);
        UMConfigure.setLogEnabled(true);
    }

    private void initBugly() {
        CrashReport.initCrashReport(getApplicationContext(), "be92172376", true);
    }
    ...
    public void initJPush() {
        JPushInterface.setDebugMode(BuildVars.DEBUG_TYPE);
