...
//    private void loadFile(final String apkUrl, final SecureDocument secureDocument, final WebFile webDocument, TLRPC.TL_fileLocationToBeDeprecated location, final ImageLocation imageLocation, final Object parentObject, final String locationExt, final int locationSize, final int priority) {
//        String fileName = getAttachFileName(apkUrl);
//
//        if (!TextUtils.isEmpty(fileName) && !fileName.contains("" + Integer.MIN_VALUE)) {
//            loadOperationPathsUI.put(fileName, true);
//        }
//        fileLoaderQueue.postRunnable(() -> loadFileInternal(apkUrl, secureDocument, webDocument, location, imageLocation, parentObject, locationExt, locationSize, priority, null, 0, false));
//    }
...
//    public static String getAttachFileName(String apkUrl) {
//        String docExt = fixFileName("wegram");
////        int idx;
